<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product-Brand.aspx.cs" Inherits="Shop.Product_Brand" %>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
        <%--<span class="l"><a class="btn btn-primary radius" onclick="picture_add('添加商品','product-add.aspx')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 新增品牌</a></span>--%>
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				...
				<%--<tr class="text-c">
					...
					<td>1</td>
					<td class="text-l">阿迪达斯</td>
                    <td style="height:100px; overflow:hidden"><img src="images/logo/adidas.jpg" style="height:100px;"/></td>
