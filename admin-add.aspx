<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-add.aspx.cs" Inherits="Shop.admin_add" %>
...
<article class="page-container">
	...
	<div class="row cl">
		<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input class="btn btn-primary radius" id="btn2" type="button" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
		</div>
	</div>
	</form>
</article>
