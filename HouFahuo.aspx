<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HouFahuo.aspx.cs" Inherits="Shop.HouFahuo" %>
...
/*产品-发布*/
$(function () {
    $('button[name=FabuOrder]').click(function () {
        var that = this;
        ...
        $.ajax(
            {
                ...
                type: 'POST',
                data: { action: "Update", uid: $(that).data('uid'), onum: $(that).data('onum'), type: '待收货' }
            }).done(function (res) {
                if (res === '200') {
                    $(that).parents("tr").find(".td-status").html('<span class="label label-success radius">已发货</span>');
